...
export function customersUpdate(
  ...
  Result<
    operations.CustomersUpdateResponseBody,
    | errors.CustomersUpdateResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CustomersUpdateResponseBody$inboundSchema),
    M.jsonErr(404, errors.CustomersUpdateResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
