...
export async function subscriptionsCreate(
  ...
  Result<
    operations.SubscriptionCreateResponseBody,
    | errors.SubscriptionCreateResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.SubscriptionCreateResponseBody$inboundSchema),
    M.jsonErr(400, errors.SubscriptionCreateResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
