...
export function transactionsCreate(
  ...
  Result<
    ...
    | errors.TransactionsCreateResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TransactionsCreateRequestBody$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(404, errors.TransactionsCreateResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
